...
import static ar.edu.itba.ss.simulator.utils.ParseUtils.parsePlanetsToEarth;
import static ar.edu.itba.ss.simulator.utils.ParseUtils.parsePlanetsToVenus;

public class PlanetsParserToEarth {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PlanetsParserToEarth.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        parsePlanetsToEarth(assetsStaticDir, assetsDynamicDir, earthFile, venusFile, sunFile, DISTANCE_TO_SPACESHIP);
