...
public class ParseUtils {
    ...
    public static void parsePlanetsToVenus(final String staticDir, final String dynamicDir, final File earthFile, final File venusFile, final File sunFile, final double distanceToSpaceship) throws FileNotFoundException {
        ...
        for (String date : planetPositions.keySet()) {
            ...
            try (PrintWriter pw = new PrintWriter(outFile)) {
                ...
                //Position
                double spaceshipx = (distanceToSpaceship + earthR) * -rx + earthx;
                double spaceshipy = (distanceToSpaceship + earthR) * -ry + earthy;
    ...
    public static void parsePlanetsToEarth(final String staticDir,
                                           final String dynamicDir,
                                           final File earthFile,
                                           final File venusFile,
                                           final File sunFile,
                                           final double distanceToSpaceship) throws FileNotFoundException {
        ...
        for (String date : planetPositions.keySet()) {
            ...
            try (PrintWriter pw = new PrintWriter(outFile)) {
                ...
                double sunx = parseDouble(sunPosition.get(0));
                double suny = parseDouble(sunPosition.get(1));
                double venusx = parseDouble(venusPosition.get(0));
                ...
                //Position
                double spaceshipx = (distanceToSpaceship + venusR) * rx + venusx;
