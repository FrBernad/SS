...
public class SimulatorPhase {
    private static final Logger LOGGER = LoggerFactory.getLogger(SimulatorPhase.class);
    ...
    private static BaseArgumentsWithPhase getAndParseBaseArguments(final Properties properties) throws IllegalArgumentException {
