...
def main(config_file: str):
    ...
    if config.generator_config.generate:
        ...
        cmd = (f'java '
               ...
               f'-Dw={config.generator_config.w} '
               f'-DA={config.generator_config.A} '
               f'-DminTheta={config.generator_config.min_theta} '
               f'-DmaxTheta={config.generator_config.max_theta} '
               ...
               f'-cp jars/classes.jar ar.edu.itba.ss.simulator.ParticlesGeneratorPhase ')
        os.system(cmd)
    else:
    ...
    cmd = (f'java '
           ...
           f'-Dw={config.simulator_config.w} '
           f'-Dr0={config.simulator_config.r0} '
